 ...
 *sur des machines reliés en réseau, via OpenMPI et d’en faire le rendu sur chaque machine. \n
 ...
 * Les machines doivent avoir d'installer openMPI version 4.0.3, openMesh version 8.1,  openGL et SDL2 pour fonctionné \n
 ...
 * mpiCC -Wall -std=c++11 *.cpp -o main -lGLEW -lGL -lGLU -lSDL2 -lOpenMeshCore \n
  * Puis ensuite mettre le programme dans un cluster avec l'objet 3D et exécuté la commande : \n
    * Puis ensuite mettre le programme dans un cluster avec l'objet 3D et exécuté la commande : \n
